...
def build_parser():
    ...
    init.add_argument(
        "--elastic",
        action="store_true",
        help="Initialize with elasticserach docker file installed",
    )
    ...
    job_list.add_argument("--local", default=False, action="store_true", help="Show local jobs in .eskit/jobs generated by archive commands.")

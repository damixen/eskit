...
from eskit.render.generic import render_fields, render_table_2, render_heading
...
def render_status(status):
    ...
    render_table_2(project(status["caches"], CACHE_DISPLAY.paths()), CACHE_DISPLAY, CACHE_SCHEMA)
